...
Процедура ВыгрузитьКонфигурациюХранилищаВФайл(Отказ)
	...
	ПутьККонфигурацииХранилища = "/IBConnectionString""Srvr=testserver; Ref='testbase'""";
	Логин1сХранилища = "Вдовенко";
	Пароль1сХранилища = "";
	
	ПутьКХранилищу = "\\testpath\...";
	ПользовательХранилища = "Вдовенко";
	ПарольХранилища = "";
...
Функция ПодключитьсяКТестовойБазе()
	...
	ПутьКТестовойБазе = "/F""D:\1C_Bases\Тест""";
	ЛогинТестовой = "Вдовенко";
	ПарольТестовой = "";
...
// оставлено для примера и напоминания, что можно и так

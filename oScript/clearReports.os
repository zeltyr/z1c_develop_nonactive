...
Функция ПеревестиВСекунды (пЧислоДляПеревода, ВидПериода = "День")
	...
	Если ВидПериода = "Минута" Тогда
		Рез = пЧислоДляПеревода * ВсегоСекунд;

	ИначеЕсли ВидПериода = "Час" Тогда
		Рез = пЧислоДляПеревода * ВсегоМинут * ВсегоСекунд;

	ИначеЕсли ВидПериода = "День" Тогда
		Рез = пЧислоДляПеревода * ВсегоЧасов * ВсегоМинут * ВсегоСекунд;

	ИначеЕсли ВидПериода = "Неделя" Тогда
		Рез = пЧислоДляПеревода * ДнейВНеделе * ВсегоЧасов * ВсегоМинут * ВсегоСекунд;
